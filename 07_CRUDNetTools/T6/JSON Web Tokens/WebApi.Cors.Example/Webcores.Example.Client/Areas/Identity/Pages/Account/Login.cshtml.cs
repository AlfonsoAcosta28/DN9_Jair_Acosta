...
namespace Webcores.Example.Client.Areas.Identity.Pages.Account
{
    public class LoginModel : PageModel
    {
        ...
        public LoginModel(ILogger<LoginModel> logger, IClaimPrincipalManager claimPrincipalManager)
        {
            _logger = logger;
