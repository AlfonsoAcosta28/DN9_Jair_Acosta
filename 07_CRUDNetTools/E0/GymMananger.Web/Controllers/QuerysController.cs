...
namespace GymManager.Web.Controllers
{
    ...
    public class QuerysController : ControllerBase
    {
        ...
        public QuerysController(IRepository<int, Member> repositoryMembers, IAttendaceAppService repositoryAttendace, IMapper maper)
        {
           memberAppService = new MemberAppService(repositoryMembers, maper);
        ...
        {
            AttendanceDto element = new AttendanceDto
            {
