...
namespace GymManager.Web.Controllers
{
    public class MembershipTypesController : Controller
    {
        ...
        {
            List<MembershipTypeDto> members = await _membershipTypesAppService.GetMembershipTypeAsync();
        ...
        [HttpPost]
        public async Task<IActionResult> Create(MembershipTypeDto member)
        {
        ...
        {
            MembershipTypeDto memberViewModel = await _membershipTypesAppService.GetMembershipTypeAsync(memberId);


            return View(memberViewModel);
        }
        [HttpPost]
        public async Task<IActionResult> Edit(MembershipTypeDto model)
        {
